...
publicclassSalariedEmployeeDialogextendsJDialog{

privatebooleandismissedWithOk;
privateSalariedEmployeeemployee;
privateJTextFieldnameTextField;
privateJTextFieldhireDateTextField;
privateJTextFieldsalaryTextField;
privateStringvalidationErrors;
/**
*Usethisconstructorifyou'recreatinganewemployee.
*/
publicSalariedEmployeeDialog(Frameparent){
this(parent,"NewEmployee",newSalariedEmployee(""));
}
...
JLabelsalaryLabel=newJLabel("AnnualSalary:");
salaryTextField=
newJTextField(newDouble(employee.getAnnualSalary()).toString(),20);
...
employee=
newSalariedEmployee(nameTextField.getText(),
...
publicSalariedEmployeegetEmployee(){
returnemployee;
}

publicstaticvoidmain(String[]args){
SalariedEmployeeDialogsed=newSalariedEmployeeDialog(null);
