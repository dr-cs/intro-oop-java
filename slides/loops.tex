...
Here's an example adapted from  \link{\code/Switch.java}{Switch.java}.  We use the {\tt for} loop's index variable to visit each character in a {\tt String} and count the digits and letters:
\begin{lstlisting}[language=Java]
